package com.dev7ex.multiwarp.translation;
...
import com.dev7ex.multiwarp.api.bukkit.translation.BukkitTranslationProvider;
...
public class DefaultTranslationProvider implements PluginModule, BukkitTranslationProvider {
    ...
    public void onEnable() {
        ...
        MultiWarpPlugin.getInstance().getLogger().info("Found: [" + this.translationConfigurations.size() + "] Translations");
    }
